          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 rounded-xl p-8 text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-white">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m0 0L14 18m-5 0v-5" />
                </svg>
              </div>
              <h4 className="text-xl font-semibold text-gray-900 mb-4">E-commerce</h4>
              <p className="text-gray-600">Unboxing experiences, product tutorials, and customer reviews.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-8 text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-white">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-4">Food & Beverage</h4>
              <p className="text-gray-600">Origin stories, recipes, nutritional information, and sustainability.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-8 text-center">
              <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center text-white">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-4">Beauty & Cosmetics</h4>
              <p className="text-gray-600">Usage tutorials, ingredient information, and loyalty programs.</p>
            </div>
          </div>
        </div>
      </div>
